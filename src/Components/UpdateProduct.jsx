...
const UpdateProduct = () => {
    ...
    const handleUpdate = (e) => {
        ...
        fetch(`https://brand-shop-server-side-k045thmoo-anfal11.vercel.app/updateProduct/${product._id}`, {
            method: "PUT",
            headers: {
...
<h1 className="font-Rancho text-6xl text-center pt-10">Update product</h1>
...
<div className="flex flex-col lg:flex-row justify-between">
  ...
  <label className="input-group">
   ...
   <div className="flex justify-center">
      <input type="submit" value='Update Product' className="btn bg-[#d1e0ee] font-Rancho text-2xl mt-6 md:w-[300px] lg:w-[740px] xl:w-[1000px] border-black" />
   </div>
